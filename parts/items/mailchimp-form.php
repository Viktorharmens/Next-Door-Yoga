...
<form action="https://nextdooryoga.us13.list-manage.com/subscribe/post?u=50c9667e8d0b928e97bc21ae5&amp;id=0efd945ef1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div class="mc_embed_signup_scroll">
        ...
        <div class="mc-field-group">
            <input type="text" value="" name="FNAME" class="name" id="mce-FNAME" placeholder="<?php _e('Vul je naam in','ndy'); ?>" />
            <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="<?php _e('Vul je e-mailadres in','ndy'); ?>" />
        </div>
        <div id="mce-responses" class="clear">
            <div class="response" id="mce-error-response" style="display:none"></div>
            <div class="response" id="mce-success-response" style="display:none"><?php _e('Bedankt voor je inschrijving','ndy') ?></div>

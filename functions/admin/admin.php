<?php
	...
	function shortcode_cta_button_init () {
		...
		add_filter('mce_external_plugins', 'register_faq_button_plugin'); 
	...
	// This callback registers the plug-in
	function register_faq_button_plugin ($plugin_array) {
		$plugin_array['vm_faq_button'] = get_stylesheet_directory_uri() . '/functions/admin/assets/tinymce-faqbutton/faq-button-shortcode.js';
		return $plugin_array;
	}
